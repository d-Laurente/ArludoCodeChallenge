...
// React component displaying movie info
const MovieCards = (props) => {

  // return movie times when given a movie id (mid)
  const showTimes = (mid) => {
    let times = [];
    const mtimes = props.tinfo.showtimes[mid];
    sortTimeList(props.tinfo.showtimes[mid]);

    // iterate through sorted times and fade out showtimes that have already started
